...
In the notebook that is launched I illustrate how to use the script and some of the various options it has. ** Alternatively, the notebook with most of resources can be viewed statically [here](PUT URL HERE)<----PUT URL HERE.
